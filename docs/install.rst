...
*Aughra* requires Python 3.7 or later. If you do not already have a Python
...
your computer and you intend to install Aughra inside of it. If you want to
...
You can install the latest distributed package of Aughra by using ``pip``::
...
repository of Aughra::

    $ git clone https://github.com/frootlab/aughra.git
...
Aughra uses the Python builtin module :module:`unittest` for testing. Since the
